...
import Choose1 from "../../../Assets/img/choose-about6.jpg";
import Choose2 from "../../../Assets/img/choose-about3.jpg";
import Choose3 from "../../../Assets/img/choose-about4.jpg";
import Choose4 from "../../../Assets/img/choose-about5.jpg";

const WhyChooseUs = () => {
  return (
    <div className="grid grid-cols-1 gap-8 md:grid-cols-1 lg:grid-cols-2 py-content-spacing-lg">
