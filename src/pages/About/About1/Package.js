...
import { team } from '../../../common/Data/CarouselItem';

const Packages = () => {
  return (
    <div className="py-content-spacing-lg">
      ...
      <div className={`animate grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-10`}>
        {team.map((item, index) => (
          <div key={index} className="image-container-best">
            <img src={item.imageSrc} alt="portfolio" className="w-width-100 h-height-400" loading="lazy" />
