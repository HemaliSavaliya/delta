...
import { blogs } from '../common/Data/CarouselItem';
import { Link } from "react-router-dom";

const Blogs = () => {
  return (
    <section className="py-content-spacing-xs lg:py-content-spacing-lg md:py-content-spacing-md sm:py-content-spacing-xs bg-background-light">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-1 lg:grid-cols-2">
          {blogs.map((blog, index) => (
            <div key={index}>
              <div className="h-full flex sm:flex-row flex-col items-center justify-center text-left bg-white rounded-lg box">
