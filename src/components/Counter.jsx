...
import { counterItems } from '../common/Data/CarouselItem';
...
const Counter = () => {
  ...
  return (
    <section ref={ref} className="pb-content-spacing-xs lg:pb-content-spacing-lg md:pb-content-spacing-md sm:pb-content-spacing-xs">
