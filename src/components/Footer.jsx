    ...
    <footer className="dark footer-style-09 bg-background-dark">
      <div className="py-spacing-p xs:py-spacing-p-13-f px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3">
          <div className="text-start last:m-0 md:mt-spacing-m-25 text-white">
            <span><img src={logo} alt="Logo" className="w-[50px]" /></span>
          ...
          <div className="mb-spacing-m text-grey-text lg:text-end">
            <span className="mb-spacing-mb-15 block leading-l-18 mt-spacing-mb-15">Connect with social</span>

            <ul className="flex gap-4 cursor-pointer lg:justify-end lg:items-end">
              <li>
                <Link to="https://facebook.com/" aria-label="Visit our Facebook page"><BiLogoFacebook /></Link>
              </li>
              <li>
                <Link to="https://instagram.com/" aria-label="Visit our Instagram page"><BiLogoInstagram /></Link>
              </li>
              <li>
                <Link to="https://linkedin.com/" aria-label="Visit our LinkedIn page"><BiLogoLinkedin /></Link>
              </li>
            </ul>
          </div>
        </div>
