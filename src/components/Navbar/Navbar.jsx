      ...
      <nav id="headerBar" className="navbar flex justify-between items-center" style={{ backgroundColor: navbarColor, color: textColor }}>
        ...
        <div className="flex gap-3">
          ...
          <div className="social" style={{ color: textColor }}>
            <div><Link to="https://facebook.com/" aria-label="Visit our Facebook page"><BiLogoFacebook /></Link></div>
            <div><Link to="https://instagram.com/" aria-label="Visit our Instagram page"><BiLogoInstagram /></Link></div>
            <div><Link to="https://linkedin.com/" aria-label="Visit our LinkedIn page"><BiLogoLinkedin /></Link></div>
          </div>
        </div>
      </nav>
    </header>
